...
<head>
    ...
    <title>3 тиждень - Плечі + Руки </title>
...
<body>
    ...
    <div class="trainer-card">
        ...
        <p>❖ Плечі + Руки </p>
        <hr>
        <h3>❖Третє тренування: ❖ Плечі + Руки /h3>
        <h3>1) Жим Арнольда на лаві </h3>
        ...
        <video src="../videos/weeks/3-week/12.mp4" preload="auto" controls="controls" class="video"></video>
        <hr>
        <h3>2) Тяга каната задня дельта   </h3>
        <ul class="lesson-list">
            <li>❖ 4 підходи з 12 повторень </li>
            <li>Вагу потрібно буде підбирати так, щоб останні 2-3 повторення були у натяжку - протягом усіх робочих підходів. </li>
        </ul>

        <video src="../videos/weeks/3-week/13.mp4" preload="auto" controls="controls" class="video"></video>
        ...
        <h3>Протяжка Z-грифа</h3>
        <video src="../videos/weeks/3-week/14.mp4" preload="auto" controls="controls" class="video"></video>
        
        <h3>Піднімемо блінця перед собою</h3>
        <video src="../videos/weeks/3-week/15.mp4" preload="auto" controls="controls" class="video"></video>

        <hr>
        <h3>4) Зворотні віджимання   </h3>
        <ul class="lesson-list">
            <li>❖ 4 підходи з 12 повторень  </li>
            <li>Робота з власною вагою</li>
        </ul>

        <video src="../videos/weeks/3-week/16.mp4" preload="auto" controls="controls" class="video"></video>

        <hr>
        <h3>5) Молотки на біцепс  </h3>
        <ul class="lesson-list">
            <li>❖ 4 підходи з 12 повторень  </li>
            <li>Вагу потрібно буде підбирати так, щоб останні 2-3 повторення були у натяжку - протягом усіх робочих підходів. </li>
        </ul>

        <video src="../videos/weeks/3-week/17.mp4" preload="auto" controls="controls" class="video"></video>
        
        <hr>
        <div class="section-links">
        <a href="3-week-2.php">Минуле заняття</a>
        <a href="../index.php">Повернутися на головну</a>
        <a href="4-week-1.php">Наступний тиждень</a>
        </div>
    </div>
    </div>
</body>
